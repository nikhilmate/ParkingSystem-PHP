                ...
                <div>
                    <div class="col-md-12">
                        <div class="product-bit-title text-center">
                            <form enctype="multipart/form-data" action="inc/setup.inc.php" class="checkout" method="POST" name="checkout">

                                <div id="customer_details" class="col2-set">
                                    <div class="col-1">
                                        <div class="row page-title text-center wow zoomInDown" data-wow-delay="1s">
                    <h2 class="theme">Set up!</h2>
                </div>
                                        <div class="woocommerce-billing-fields">
                                            ...
                                            <p id="billing_last_name_field" class="form-row form-row-last validate-required">
                                                ...
                                                <input type="password" value="" placeholder="Password" id="billing_last_name" name="pass1" class="input-text ">
                                            </p>
                                            <div class="clear"></div>

                                            <p id="billing_last_name_field" class="form-row form-row-last validate-required">
                                                <label class="text-left" for="billing_last_name">Conform Password<abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="password" value="" placeholder="Password" id="billing_last_name" name="pass2" class="input-text ">
                                            </p>
                                            <div class="clear"></div>
                                        
                                            <div class="form-row place-order">
                                            <input type="submit" data-value="Place order" value="Submit" id="place_order" name="submit-setup" class="button alt form-register pull-right">
                                        </div>
                                        <div class="clear"></div>
                                        </div>
                                        </div>
