    ...
    <body>
              ...
              <div class="button navbar-right">
                <?php 
                    if (isset($_SESSION['u_email'])) {
                        echo "<form action='inc/logout.inc.php' method='post'><button type='submit' name='logout' class=\"navbar-btn nav-button wow bounceInRight login\" data-wow-delay=\"0.8s\">Logout</button></form>";
                    } else {
                ...
                <div>
                    <div class="col-md-12">
                        <div class="product-bit-title text-center">
                            <form enctype="multipart/form-data" action="inc/park_entry.inc.php" class="checkout" method="post" name="park-entry">

                                <div id="customer_details" class="col2-set">
                                    <div class="col-1">
                                        <div class="row page-title text-center wow zoomInDown" data-wow-delay="1s">
                    <h2 class="theme">Park Your vehicle!</h2>
                </div>
                                        <div class="woocommerce-billing-fields">

                                            <p id="billing_country_field" class="form-row text-left form-row-wide address-field update_totals_on_change validate-required woocommerce-validated">
                                                <label class="" for="region">Select Region <abbr title="required" class="required">*</abbr>
                                                </label>
                                                <select class="country_to_state country_select" id="region" name="region">
                                                    <option value="" selected="selected">Select a region…</option>
                                                    <?php
                                                    include "inc/dbc.inc.php";
                                                    $sql = "SELECT * FROM regions_included";
                                            ...
                                            <p id="billing_country_field" class="form-row text-left form-row-wide address-field update_totals_on_change validate-required woocommerce-validated">
                                                <label class="" for="region">Select Area <abbr title="required" class="required">*</abbr>
                                                </label>
                                                <select class="country_to_state country_select" id="area" name="area">
                                            ...
                                            <p id="billing_last_name_field" class="form-row form-row-last validate-required">
                                                <label class="text-left" for="billing_last_name">Vehicle No.<abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="text" value="" placeholder="Example: MH 04 TA 222" id="vehicle_no" name="vehicle_no" class="input-text ">
                                            </p>
                                            <div class="clear"></div>

                                            <p id="billing_last_name_field" class="form-row form-row-last validate-required">
                                                <label class="text-left" for="billing_last_name">Valid From <abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="datetime-local" value="" id="valid_from" name="valid_from" class="input-text ">
                                            </p>
                                            <div class="clear"></div>

                                            <p id="billing_last_name_field" class="form-row form-row-last validate-required">
                                                <label class="text-left" for="billing_last_name">Valid To <abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="datetime-local" value="" id="valid_to" name="valid_to" class="input-text ">
                                            </p>
                                            <div class="clear"></div>
                                            
                                            <div class="form-row place-order">
                                            <input type="submit" data-value="Place order" value="Submit" id="place_order" name="submit-entry" class="button alt form-register pull-right">
                                        </div>
                                        <div class="clear"></div>
                                        </div>
                                        </div>
		...
		<script type="text/javascript">
            function update() {
                ...
                var url = 'inc/area_chhose.php?region=' + region_selected;
